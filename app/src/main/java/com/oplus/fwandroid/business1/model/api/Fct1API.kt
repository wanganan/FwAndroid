package com.oplus.fwandroid.business1.model.api
...
//    open fun getUser(@Url url: String?): Call<User?>?
    ...
    fun getFct1EntityList(@QueryMap map: Map<String?, String?>?): Flowable<BaseResponse<ArrayList<Fct1Entity>>>
