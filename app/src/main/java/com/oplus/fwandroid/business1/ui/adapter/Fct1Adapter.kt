package com.oplus.fwandroid.business1.ui.adapter
 ...
 * description：功能对应数据适配。
 * version: 1.0
 */
class Fct1Adapter(layoutId: Int, data: MutableList<Fct1Entity>? = null) :
    BaseQuickAdapter<Fct1Entity, BaseViewHolder>(layoutId, data) {
    override fun convert(helper: BaseViewHolder, item: Fct1Entity) {
        item?.let {
        ...
        GlideHelper.display(ivLogo,item.mainPic!!)
    }
}