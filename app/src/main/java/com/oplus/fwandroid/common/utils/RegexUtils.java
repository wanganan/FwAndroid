...
public class RegexUtils {
     ...
     * 匹配手机号码的正则表达式
     */
    public static final String PHONE_NUMBER_REGEX = "1[345789]\\d{9}";

    /**
     * 匹配只能输入数字和字母的正则表达式
     */
    public static final String PWD_REGEX = "^[A-Za-z0-9]+$";
    /**
     * 匹配只能输入数字和字母组合的正则表达式
     */
    public static final String PWD_COMBINE_REGEX = ".*[a-zA-Z].*[0-9]|.*[0-9].*[a-zA-Z]";
    /**
     * 匹配邮箱的正则表达式
     * <br>"www."可省略不写
     */
     ...
     * @return true: 是
     */
    public static boolean isPasWord(String pro) {
     ...
     * @return true: 是
     */
    public static boolean isCombinePasWord(String pro) {
     ...
     * @return
     */
    public static boolean isAmount(String str) {//判断整型
