...
class HanziToPinyin {
    ...
    constructor(hasChinaCollator: Boolean) {
    ...
    private fun getToken(character: Char): Token {
        ...
        var j = 0
        while (j < PINYINS[offset].size && PINYINS[offset][j] != 0.toByte()) {
