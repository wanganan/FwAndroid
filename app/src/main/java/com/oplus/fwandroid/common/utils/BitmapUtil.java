...
public final class BitmapUtil {
     ...
     */
    public static Bitmap cut(Bitmap src, double widthRate, double heightRate) {
        if (widthRate > 0 && widthRate <= 1 && heightRate > 0 && heightRate <= 1) {
            Matrix matrix = new Matrix();
            return Bitmap.createBitmap(src, 0, 0, (int) (src.getWidth() *
                    widthRate), (int) (src.getHeight() * heightRate), matrix, true);
        }else{
            return src;
        }
    }
