...
public final class AnimationUtils {
     ...
     * @return 一个缩小动画
     */
    public static ScaleAnimation getLessenScaleAnimation(float fromX, float toX, float fromY, float toY, long durationMillis) {
        return getLessenScaleAnimation(fromX, toX, fromY,
     ...
     * @return 一个缩小动画
     */
    public static ScaleAnimation getLessenScaleAnimation(float fromX, float toX, float fromY, float toY) {
        return getLessenScaleAnimation(fromX, toX, fromY,
                toY, 1000, null);
    }
    ...
    public static ScaleAnimation getLessenScaleAnimation(long durationMillis, AnimationListener animationListener) {
        return getLessenScaleAnimation(1.0f, 0.0f, 1.0f,
     ...
     * @return
     */
    public static TranslateAnimation getTranslateAnimation(float fromXDelta, float toXDelta, float fromYDelta, float toYDelta, AnimationListener animationListener) {
        return getTranslateAnimation(fromXDelta, toXDelta, fromYDelta, toYDelta, DEFAULT_ANIMATION_DURATION, animationListener);
    }
     ...
     * @return
     */
    public static TranslateAnimation getTranslateAnimation(float fromXDelta, float toXDelta, float fromYDelta, float toYDelta, long durationMillis) {
        return getTranslateAnimation(fromXDelta, toXDelta, fromYDelta, toYDelta, durationMillis, null);
    }
    ...
    public static TranslateAnimation getTranslateAnimation(float fromXDelta, float toXDelta, float fromYDelta, float toYDelta) {
        return getTranslateAnimation(fromXDelta, toXDelta, fromYDelta, toYDelta, DEFAULT_ANIMATION_DURATION);
    }
}
